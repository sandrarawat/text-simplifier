...
/**
 * Console Colour used to change colour @see Menu
 */

public enum ConsoleColour implements EnumInterface { // ANSI escape codes
	// Reset
	...
	/**
	 * @Overrides Console Colour toString to enable Strings to change colour
	 */
	@Override
